...
import {
    fetchAllEvents, selectEvent, eventListSelector, loadedSelector, loadingSelector, eventsCountSelector, fetchRows,
    PageSize
} from '../../ducks/events'
...
}), {fetchAllEvents, selectEvent, fetchRows})(EventsTableVirtualized)